...
for (past_folder in past_folders) {
  in_folder = paste0('../base/', past_folder)
  ...
  out_folder = paste0('output/canvas_', past_folder, '/')
  dir.create(out_folder, recursive = TRUE)
  
  res = exams2moodle(files_df$filename, dir = out_folder)
}
